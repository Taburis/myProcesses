...
config.General.requestName ='trkMVA_ntuple_cut_selection_4p4np'
...
config.JobType.inputFiles = ['extra_producer.py','select_initialStep_cfi.py', 'select_lowPtQuad_cfi.py', 'select_lowPtTriple_cfi.py', 'select_highPtTriple_cfi.py']
