...
merge = mj.cjob_merge(name = "bjtc_dijetMC_partialStat", nfiles=80, time ='2h',output_dir = './data', path = '/eos/cms/store/group/phys_heavyions/wangx/aa2018bjet/crab_bjtc_aa2018_dijetP8H_drum_partialStats/')
