...
class bjtc_signal_analyzer : public jtcSignalProducer{
	public : bjtc_signal_analyzer(TString name0, int npt, int ncent):jtcSignalProducer(name0,npt,ncent){
		 }
		 ~bjtc_signal_analyzer(){}
...
void bjtc_signal_analyzer::makeMixTable(){
...
void bjtc_signal_analyzer::produce(){
...
jtcTH1Player* bjtc_signal_analyzer::rebin(TString name, jtcTH1Player *js){
...
void bjtc_signal_analyzer::sb_smth_correction(jtcTH1Player *j2){
	sb_ymin = 1.8;
	sb_ymax = 2.4;
...
void bjtc_signal_analyzer::sb_correction(jtcTH1Player *j2){
	sb_ymin = 1.8;
	sb_ymax = 2.4;
...
bool bjtc_signal_analyzer::sb_check(TH1* hsig, TH1* hsb, TF1* f){
