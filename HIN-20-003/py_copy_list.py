...
eos = '/eos/user/w/wangx/www/AN20-029/bjtc_app_hw'
...
a.add(eos,'production_probe/closure_pTcombined_bias_step'+f, 'production/closureTest_bias'+f) 
#a.add(eos,'production_probe/fullClosure_pTsummed'+f, 'production/closureTest_fullTest'+f) 
#a.add(eos,'production_probe/closure_pTcombined_decont_step'+f, 'production/closureTest_decontamination'+f) 
#a.add(eos,'production_probe/closure_pTcombined_trk_step'+f, 'production/closureTest_tracking'+f) 
#a.add(eos,'production_probe/closure_pTcombined_bias_step'+f, 'production/closureTest_bias'+f) 
...
a.add(eos,'systUncert/systUncert_taggingBias.png', 'syst/systUncert_taggingBias.png') 
eos = '/eos/user/w/wangx/www/AN20-029/bjtc_c2bin_50mix_nomianl'
...
#result
eos = '/eos/user/w/wangx/www/AN20-029/bjtc_probe'
#eos = '/eos/user/w/wangx/www/AN20-029/bjtc_c2bin_50mix_newbin'
...
a.add(eos,'Results/figure_nominal_fig2.pdf', 'Results/Figure03.pdf')
a.add(eos,'Results/figure_nominal_js_bjet_vs_incl.pdf', 'Results/Figure04.pdf')
eos = '/eos/user/w/wangx/www/AN20-029/bjtc_arc'
a.add(eos,'Results/propose_fig2.pdf', 'Results/Figure05.pdf')
